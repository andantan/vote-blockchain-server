...
func main() {
	...
	proposals := []*VoteProposalRequest{
		...
		NewVoteProposalRequest("2025 보건의료 여론조사", 2),
		NewVoteProposalRequest("법률개정안 찬반 투표", 2),
		NewVoteProposalRequest("상법개정안 시범 기간 조사", 3),
		NewVoteProposalRequest("기후변화 대응 방안 선호도 조사", 3),
